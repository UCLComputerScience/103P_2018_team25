"""
Django settings for ixn project.
...
ALLOWED_HOSTS = ['purlllipym.localtunnel.me', 'localhost'] # To allow localtunnel
...
WSGI_APPLICATION = 'ixn.wsgi.application'
